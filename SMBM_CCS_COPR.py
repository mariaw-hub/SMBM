...
data_art = pd.read_csv(r'C:\Users\mwart\Box Sync\PhD\PhD\Python\Data\Climate_scenario_COPR.csv')
...
#%%
PET_art = pd.read_csv(r'C:\Users\mwart\Box Sync\PhD\PhD\Python\Data\Infiltration_COPR070420.csv') #PET with 10% change for CC3
...
art_ndvi_copr['NetP4'] = data_art['Rain'] - data_art['PET']
art_ndvi_copr['3M4'] = art_ndvi_copr.iloc[:,6].rolling(window=3).sum()

art_ndvi_copr['ndvi1'] = 1 / (1+ 1.197 * np.exp(-0.002 *art_ndvi_copr['3M1'])) #from NDVI & Net P regression 
art_ndvi_copr['ndvi2'] = 1 / (1+ 1.197 * np.exp(-0.002 *art_ndvi_copr['3M2']))
art_ndvi_copr['ndvi3'] = 1 / (1+ 1.197 * np.exp(-0.002 *art_ndvi_copr['3M3']))
art_ndvi_copr['ndvi4'] = 1 / (1+ 1.197 * np.exp(-0.002 *art_ndvi_copr['3M4']))#from historic NETP


cols = ['ndvi1','ndvi2', 'ndvi3', 'ndvi4']
art_ndvi_copr[art_ndvi_copr[cols] < 0] = 0        

art_ndvi_copr['Kc1']= 1.57*art_ndvi_copr['ndvi1'] - 0.01 #from NDVI & Net P regression
art_ndvi_copr['Kc2']= 1.57*art_ndvi_copr['ndvi2'] - 0.01 
art_ndvi_copr['Kc3']= 1.47*art_ndvi_copr['ndvi3'] - 0.01 
art_ndvi_copr['Kc4']= 1.47*art_ndvi_copr['ndvi4'] - 0.01 
...
P = P1 #Use P1,P2,P3
#P = Rain #use for netP as leading indicator
...
ax1.plot(SM_art4[0], color='blue') #historic with Netp as Lead indicator   
